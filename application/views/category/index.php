    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body tableResponsDivProCat">
      ...
      <form role="form" action="<?php echo base_url('category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Category Name <sup>*</sup></label>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_name">Category Name <sup>*</sup></label>
            <input type="text" class="form-control" id="edit_name" name="edit_name" placeholder="Enter Category" autocomplete="off">
          </div>
          <div class="form-group">
