  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createMachines', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Machine</button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Machine</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            ...
            <div class="row">
                  ...
                  <div class="col-md-2">
                        <div class="form-group">
                            <label for="contact">Machine Head</label>
                            <select class="form-control" id="filter_fixed_asset_heads_id" name="filter_fixed_asset_heads_id">
                              <option value=''>-select-</option>
                              <?php if($fixed_assest_heads){ 
                                foreach($fixed_assest_heads as $row){
                                ?>
                                  <option <?php if($filter_fixed_asset_heads_id==$row['id']){ echo "selected";} ?> value='<?php echo $row['id'];  ?>'><?php echo $row['name'];  ?></option>
                                <?php }} ?>
                            </select>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="contact">Machine Service Type</label>
                            <select class="form-control" id="filter_fixed_asset_service_type_id" name="filter_fixed_asset_service_type_id">
                              <option value=''>-select-</option>
                              <?php if($fixed_assest_service_types){ 
                                foreach($fixed_assest_service_types as $row){
                                ?>
                                  <option <?php if($filter_fixed_asset_service_type_id==$row['id']){ echo "selected";} ?> value='<?php echo $row['id'];  ?>'><?php echo $row['name'];  ?></option>
                                <?php }} ?>
                            </select>
              ...
              <?php if($is_report_download && $fixed_assests){ ?>
                <div class="box-footer">
              ...
              <div class="box-body tableResponsDiv">
                <table id="fixed_assest_tbl"  class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Heads</th>
                    <th>Type</th>
                    ...
                    <th>Details</th>
                    <!-- <th>Status</th> -->
                    <?php if(in_array('updateMachines', $user_permission) || in_array('deleteMachines', $user_permission)): ?>
                      <th>Action</th>
                    <?php endif; ?>
                  </tr>
                  </thead>
                  <tbody>
                    <?php if($fixed_assests){ 
                    foreach($fixed_assests as $row){  
                    ?>
                    <tr id="row_<?php echo $row['id'];  ?>">
                      <td><?php echo $row['fixed_asset_heads_name'];  ?></td>
                      <td><?php echo $row['fixed_asset_service_type_name'];  ?></td>
                      ...
                      <?php if(in_array('updateMachines', $user_permission) || in_array('deleteMachines', $user_permission)): ?>
                        ...
                        <td>
                        <?php if(in_array('updateMachines', $user_permission)): ?>
                        ...
                        <?php endif; ?>
                        <?php if(in_array('deleteMachines', $user_permission)): ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('machines/create') ?>" method="post" id="createForm" enctype="multipart/form-data">
        ...
        <div class="row">
           <div class="col-md-6">
              <div class="form-group">
                <label for="name">Machine Heads <sup>*</sup></label>
                <select class="form-control" name="fixed_asset_heads_id" id="fixed_asset_heads_id">
                  <option value="">-select-</option>
                  <?php if($fixed_assest_heads){
                    foreach($fixed_assest_heads as $row){
                    ?>
           ...
           <div class="col-md-6">
              <div class="form-group">
                <label for="name">Machine Service Type <sup>*</sup></label>
                <select class="form-control" name="fixed_asset_service_type_id" id="fixed_asset_service_type_id">
                  <option value="">-select-</option>
                  <?php if($fixed_assest_service_types){
                    foreach($fixed_assest_service_types as $row){
                    ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('machines/update') ?>" method="post" id="updateForm" enctype="multipart/form-data">
        ...
        <div class="modal-body">
              ...
              <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="edit_name">Machine Heads <sup>*</sup></label>
                        <select class="form-control" name="edit_fixed_asset_heads_id" id="edit_fixed_asset_heads_id">
                          <option value="">--</option>
                          <?php if($fixed_assest_heads){
                          foreach($fixed_assest_heads as $row){
                          ?>
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        <label for="edit_name">Machine Service Type<sup>*</sup></label>
                        <select class="form-control" name="edit_fixed_asset_service_type_id" id="edit_fixed_asset_service_type_id">
                          <option value="">--</option>
                          <?php if($fixed_assest_service_types){
                          foreach($fixed_assest_service_types as $row){
                          ?>
...
var manageTable;
 ...
 function resetSearch(){
    window.location.replace("<?php echo base_url('machines'); ?>");
  }

  function exportReport(){
      $("#report_form").attr("action","<?php echo base_url('machines/export_report'); ?>").submit().attr("action","");
  ...
  function serviceCompleted(service_status,id)
  {
      ...
      service_status = checkbox.checked ? 1 : 0;
       ...
       $.ajax({
          url: '<?php echo base_url('machines/service_status_update'); ?>',
          type: 'post',
...
$(document).ready(function() {
    ...
    $("#mainAssetsNav").addClass('active');
    $("#machinesNav").addClass('active');
...
{ 
  ...
  $.ajax({
    ...
    success:function(response) {
      ...
      $("#edit_fixed_asset_heads_id").val(response.heads_id);
      $("#edit_fixed_asset_service_type_id").val(response.service_type_id);
