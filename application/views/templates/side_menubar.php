    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_permission): ?>
          ...
          <?php if(in_array('viewMachines', $user_permission) || in_array('viewMachineServiceType', $user_permission) || in_array('viewMachineHeads', $user_permission)): ?>
            <li class="treeview" id="mainAssetsNav">
              ...
              <ul class="treeview-menu">
                ...
                <?php if(in_array('createMachines', $user_permission) || in_array('updateMachines', $user_permission) || in_array('viewMachines', $user_permission) || in_array('deleteMachines', $user_permission)): ?>
                  <li id="machinesNav">
                    <a href="<?php echo base_url('machines/') ?>">
                      <i class="fa fa-files-o"></i> <span>Machines</span>
                    </a>
                  </li>
                <?php endif; ?>

                  <?php if(in_array('createMachineServiceType', $user_permission) || in_array('updateMachineServiceType', $user_permission) || in_array('viewMachineServiceType', $user_permission) || in_array('deleteMachineServiceType', $user_permission)): ?>
                  <li id="machine_service_typeNav">
                    <a href="<?php echo base_url('machine_service_type/') ?>">
                      <i class="fa fa-files-o"></i> <span>Machine Service Type</span>
                    </a>
                  </li>
                <?php endif; ?>

                <?php if(in_array('createMachineHeads', $user_permission) || in_array('updateMachineHeads', $user_permission) || in_array('viewMachineHeads', $user_permission) || in_array('deleteMachineHeads', $user_permission)): ?>
                  <li id="machine_headsNav">
                    <a href="<?php echo base_url('machine_heads/') ?>">
                      <i class="fa fa-files-o"></i> <span>Machine Heads</span>
                    </a>
                  </li>
                <?php endif; ?>
          ...
          <?php if(in_array('viewCompliences', $user_permission) || in_array('viewCompliences', $user_permission) || in_array('viewCompliences', $user_permission)): ?>
            <li class="treeview" id="compliencesNav">
              <a href="#">
                <i class="fa fa-files-o"></i>
                <span>Compliences</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                 ...
                 <?php if(in_array('createCompliences', $user_permission) || in_array('updateCompliences', $user_permission) || in_array('viewCompliences', $user_permission) || in_array('deleteCompliences', $user_permission)): ?>
                  <li id="compliencesSubNav">
                    <a href="<?php echo base_url('compliences/') ?>">
                      <i class="fa fa-files-o"></i> <span>Compliences</span>
                    </a>
                  </li>
                <?php endif; ?>

                <?php if(in_array('createCompliencesServiceType', $user_permission) || in_array('updateCompliencesServiceType', $user_permission) || in_array('viewCompliencesServiceType', $user_permission) || in_array('deleteCompliencesServiceType', $user_permission)): ?>
                  <li id="compliences_service_typeNav">
                    <a href="<?php echo base_url('compliences_service_type/') ?>">
                      <i class="fa fa-files-o"></i> <span>Compliences Service Type</span>
                    </a>
                  </li>
                <?php endif; ?>

                 <?php if(in_array('createCompliencesHeads', $user_permission) || in_array('updateCompliencesHeads', $user_permission) || in_array('viewCompliencesHeads', $user_permission) || in_array('deleteCompliencesHeads', $user_permission)): ?>
                  <li id="compliences_headsNav">
                    <a href="<?php echo base_url('compliences_heads/') ?>">
                      <i class="fa fa-files-o"></i> <span>Compliences Heads</span>
                    </a>
                  </li>
                <?php endif; ?>
       ...
       <!-- <?php if(in_array('viewProfile', $user_permission)): ?>
          <li id="mainprofileNav"><a href="<?php echo base_url('users/profile/') ?>"><i class="fa fa-user-o"></i> <span>Profile</span></a></li>
        <?php endif; ?> -->
