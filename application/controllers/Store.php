...
class Store extends Admin_Controller 
{
	...
	*/
	...
	{
		if($id) {
			$data = $this->model_store->getData($id);
	...
	*/
	public function update($id)
	{
		...
		if($id) {
			$this->form_validation->set_rules('edit_name', 'Store name', 'trim|required');
	...
	*/
	public function remove()
	{
		...
		$response = array();
		if($id) {
			$delete = $this->model_store->remove($id);
			if($delete == true) {
				$response['success'] = true;
